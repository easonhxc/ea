...
- Use calibrated anchors: 50 means ordinary participation with limited detail; 70 means sustained, specific evidence; 85 means multiple completed, independently verifiable signals; 95+ requires exceptional completed work plus credible external validation. Do not use 90+ merely for selective program names, scores, titles, or plans.
- Resolve contradictions conservatively. If an activity claims impact but lacks method, output, duration, or a measurable result, treat it as partial evidence and name the uncertainty. Never infer causality, selectivity, or impact from a title alone.
- Treat the deterministic course and project analyses as evidence anchors. You may explain nuance, but do not move course_major_alignment, project_major_alignment, or interdisciplinary_fit far from the supplied analysis without a concrete textual reason.
