...
- Each item must have one observable completion test. Do not use vague actions such as "improve profile", "do research", or "build leadership" without a bounded output, method, and deadline.
- Sequence dependencies: preparation before outreach, pilot before scale, and analysis before publication. Do not schedule two time-intensive primary projects in the same month unless the profile already proves the required capacity.
- Treat all matched opportunities as optional leads, not commitments. Do not make an opportunity the center of the roadmap if it is highly selective or has an unverified current-cycle deadline.
